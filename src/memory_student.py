...
class StudentMemory:
    ...
    def retrieve_long_term(self, user_id: str, thread_id: str, query: str) -> str:
        ...
        # Keep the Context Block as the primary source. Relevant graph facts are
        # useful for auditability (source validity/recency) and preserve literal
        # open-loop markers that a generated context block may paraphrase.
        try:
            ...
            fact_text = render_graph_search(results)
        except Exception:
            # A fact-search compatibility/indexing issue must not discard an
            # otherwise valid Context Block.
            fact_text = ""
    ...
    def retrieve_semantic(self, graph_id: str, query: str) -> str:
        ...
        # Some Zep accounts/index states do not expose standalone graph source
        # episodes. Entity nodes still provide a useful compatibility fallback.
        results = self.client.graph.search(
            graph_id=graph_id,
            query=search_query,
            scope="nodes",
